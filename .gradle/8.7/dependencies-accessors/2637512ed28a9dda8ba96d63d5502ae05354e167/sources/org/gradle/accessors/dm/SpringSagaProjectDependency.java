...
@NonNullApi
public class SpringSagaProjectDependency extends DelegatingProjectDependency {

    @Inject
    public SpringSagaProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
